...
def vlookup():
   try:
      ...
      # ----Define first DataFrame, especificando que el encabezado empieza en le fila 3 ya que en el codigo de columna la fila 1 es 0 entonces la 3 es 2
      excel_YRA2 = pd.read_excel(YRA2_file_path, header=0)
